...
<div class="container-fluid">
    ...
    <form id="form_edit_training">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="row">
                            ...
                            <input type="checkbox" name="edit_training_ratings" id="edit_training_ratings" class="form-control pt-2 col-2" value='1' @if ($training[0]->Ratings==1) checked @endif>
                        </div>
                    </div>
        ...
        <div class="text-center">
            <a href="{{ route('page.training.emp') }}"><button type="button" class="btn btn-outline-info">Cancel</button></a>
