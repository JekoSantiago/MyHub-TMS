<div id="modal_emp_rating" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-center">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_emp_ratings">
                    <fieldset>
                    <input type="hidden" id="TrainEmp_ID" name = "TrainEmp_ID">
                    <div class="form-group">
                        <div class="row pl-3">
                            <h3 id="emp_name_ratings"></h3>
                        </div>
                        ...
                        <div class="row" id="isRatings">
                            ...
                            <div class="col-md-8 pt-1">
                                <input type="number" name="ratings_emp" id="ratings_emp" max="100" min="0">
                                <label class="invalid-feedback" id="ratings_emp_error">Rating should not be less than 0 nor morethan 100</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col pl-5">
